...
export const drawProducts = () => {
    ...
    const api = `https://demo-web3-xi.vercel.app/products?q=${objectBien.q}&_page=${objectBien.page}&_limit=${objectBien.limit}&_sort=${objectBien.sort}&_order=${objectBien.order}${thayDoi}`
    fetchApi(api)
    .then(data => {
